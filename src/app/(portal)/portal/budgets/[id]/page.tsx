    ...
    <div className={styles.content}>
      ...
      <div className={styles.section}>
        <div className={styles.sectionHeader}>
          ...
          <Link href={`/portal/budgets/${id}/add-item`} className={styles.button}>
            ADD LINE ITEM
          </Link>
        </div>
    ...
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <div className={styles.actions}>
          <Link href={`/portal/budgets/${id}/edit`} className={styles.button}>
            EDIT
          </Link>
          <Link href={`/portal/budgets/${id}/approve`} className={styles.button}>
            APPROVE
          </Link>
        </div>
      </div>
